...
const ItemList = () => {
   // Dataset contains all items; showData contains the current page's data
   const [dummyData, setDummyData] = useState(dataset.slice(0, 10)); // Load first 10 items
   const [page, setPage] = useState(1);  // Track current page

   const loadMoreData = () => {
      const newPage = page + 1;
      const newData = dataset.slice(0, newPage * 10); // Load next 10 items
